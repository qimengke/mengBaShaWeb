$(function(){
	...
	/*******验证码********/
	var index = 0;
	var arryPic = ["img/注册登录页/login20.gif","img/注册登录页/login21.gif","img/注册登录页/login22.gif",
		"img/注册登录页/login23.gif","img/注册登录页/login24.gif"];
	...
	$(".content .right .formTwo .one").blur(function(){
		...
		if($value != arryWord[index]){
			...
			$(this).css({
				"background": "url(img/注册登录页/gou.jpg) no-repeat 90px 12px",
				"border": "1px solid #C9C9C9"
			});
		}
